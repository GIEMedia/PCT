...
namespace PST.Api.Areas.HelpPage
{
    /// <summary>
    ...
    public class ObjectGenerator
    {
        ...
        private static void SetPublicProperties(Type type, object obj, Dictionary<Type, object> createdObjectReferences)
        {
            ...
            foreach (var property in properties)
            {
                if (property.CanWrite)
                {
                    ...
                    if (!TrySetKnowFieldTypesByName(property.Name, property.PropertyType, type, out propertyValue))
                        propertyValue = objectGenerator.GenerateObject(property.PropertyType, createdObjectReferences);
        ...
        private static void SetPublicFields(Type type, object obj, Dictionary<Type, object> createdObjectReferences)
        {
            ...
            {
                object fieldValue;
                if (!TrySetKnowFieldTypesByName(field.Name, field.FieldType, type, out fieldValue))
                    fieldValue = objectGenerator.GenerateObject(field.FieldType, createdObjectReferences);
                field.SetValue(obj, fieldValue);
            }
        }

        private static bool TrySetKnowFieldTypesByName(string name, Type type, Type parentType, out object value)
        {
            value = null;
            ...
            if (type == typeof (string))
            {
                if (string.Equals(name, "id", StringComparison.InvariantCultureIgnoreCase) ||
                    name.EndsWith("_id", StringComparison.InvariantCultureIgnoreCase))
                    value = Guid.NewGuid().ToString();
                else if (string.Equals(name, "phone", StringComparison.InvariantCultureIgnoreCase) ||
                         name.EndsWith("_phone", StringComparison.InvariantCultureIgnoreCase))
                    value = "4446668989";
                else if (string.Equals(name, "url", StringComparison.InvariantCultureIgnoreCase) ||
                         name.EndsWith("_url", StringComparison.InvariantCultureIgnoreCase))
                    value = "http://www.somedomain.com/someplace";
                else if (string.Equals(name, "image", StringComparison.InvariantCultureIgnoreCase) ||
                         name.EndsWith("_image", StringComparison.InvariantCultureIgnoreCase))
                    value = "http://www.somedomain.com/someimage.jpg";
                else if (string.Equals(name, "email", StringComparison.InvariantCultureIgnoreCase) ||
                         name.EndsWith("_email", StringComparison.InvariantCultureIgnoreCase))
                    value = "someone@somewhere.com";
                else if (string.Equals(name, "color", StringComparison.InvariantCultureIgnoreCase) ||
                         name.EndsWith("_color", StringComparison.InvariantCultureIgnoreCase))
                    value = "#ff0011";
            }
