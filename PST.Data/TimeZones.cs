...
namespace PST.Data
{
    ...
    {
        private static Dictionary<string, TimeZoneInfo> _timeZonesByStates;

        public static Dictionary<string, TimeZoneInfo> TimeZonesByState
        {
            get
            {
                return _timeZonesByStates ?? (_timeZonesByStates = new Dictionary<string, TimeZoneInfo>
                {
                    ...
                    {"AZ", TimeZoneInfo.FindSystemTimeZoneById("US Mountain Standard Time")},
